...
X_test_final = []
y_test_final = []
input_traindata_path = "./resources/WordAlign/speaker_input_train"
output_traindata_path = "./resources/WordAlign/speaker_final_output_train"
input_testdata_path = "./resources/WordAlign/speaker_input_test"
output_testdata_path = "./resources/WordAlign/speaker_final_output_test"


for speaker_id in range(1, 2): #range(1,33)
	# for j in range(0,12):
	...
	net.fit(X_train, y_train, batch_size=100, nb_epoch=100, validation_split=0.0)
...
score,acc = net.evaluate(X_test_final,y_test_final)
